...
Let's redefine our basic unit of time. Instead of one second, we use one **MahiSecond**, which is exactly **0.423 seconds**. This allows us to create a more orderly system of time measurement:

- **1 MahiSecond** = 0.423 seconds
- **1 MahiMinute** = 100 MahiSeconds (42.3 seconds)
- **1 MahiHour** = 100 MahiMinutes (70 minutes and 30 seconds)
...
By adopting **MahiSeconds** (0.423 seconds), we create a more orderly and precise time system:

- **MahiMinutes** (100 MahiSeconds, ~42.3 seconds)
- **MahiHours** (100 MahiMinutes, ~70.5 minutes)
- **Civil Day** (20 MahiHours)
- **MahiDays** (20.0178 MahiHours)
